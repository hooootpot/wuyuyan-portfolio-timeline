(() => {
  const copy = {
    zh: {
      ...
      projectRoles: ["游戏设计 · 2D 美术 · UNITY", "2D 美术 · 视觉脚本 · UNITY", "3D 建模 · 材质 · 交互", "UE5 · 动作角色扮演", "UE4 · 战斗系统 · 敌人 AI", "视觉与美术方向 · 解谜", "2D 平台 · 双手控制 · 场景切换", "3D 美术 · 增强现实 · 界面"],
      projectSummaries: [
        ...
        "围绕双手控制与场景切换设计的 2D 平台游戏，于 Global Game Jam 2022 完成。",
        "面向 AR 场景的五人协作项目；参与玩法策划，并完成 3D 模型、动画、材质及 UI 动效。"
      ],
      projectHover: "查看项目",
      projectPdfHover: "在作品集中查看",
      sourceNote: "* 点击时间轴中的项目，可前往公开项目页查看、试玩或下载；DARKENING 将打开作品集 PDF。",
    ...
    en: {
      ...
      projectRoles: ["GAME DESIGN · 2D ART · UNITY", "2D ART · VISUAL SCRIPTING · UNITY", "3D MODELLING · TEXTURING · INTERACTION", "UE5 · ACTION RPG", "UE4 · COMBAT SYSTEM · ENEMY AI", "VISUAL & ART DIRECTION · PUZZLE", "2D PLATFORMER · DUAL-HAND CONTROL", "3D ART · AUGMENTED REALITY · UI"],
      projectSummaries: [
      ...
      projectPdfHover: "VIEW IN PORTFOLIO",
      sourceNote: "* Select a timeline project to view, play or download it from the public project page; DARKENING opens the portfolio PDF.",
